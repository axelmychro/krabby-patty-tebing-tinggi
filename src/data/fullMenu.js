...
export const fullMenu = [
  {
    ...
    subcategory: 'chicken',
    label: 'Burger Ayam',
    description: 'Single chicken patty, cheese, sauce, mayonnaise',
    price: 16000,
  ...
  },
  {
    ...
    subcategory: 'chicken',
    label: 'Burger Ayam',
    description: 'DOUBLE chicken patty, cheese, sauce, mayonnaise',
    price: 22000,
  ...
  },
  {
    ...
    subcategory: 'beef',
    label: 'Burger Sapi',
    description: 'Single beef patty, cheese, sauce, mayonnaise',
    price: 19000,
  ...
  },
  {
    ...
    subcategory: 'beef',
    label: 'Burger Sapi',
    description: 'DOUBLE beef patty, cheese, sauce, mayonnaise',
    price: 28000,
